...
function Clock() {
    ...
    const start = () => {
        ...
        // сохранить ид таймера (htt ps://learn.javascript.ru/settimeout-setinterval#setinterval)
    ...
    const stringMonth = date.toLocaleString("eng", {month: 'long' })
    const stringDate = formatter1.format(date)
    const stringDay = date.toLocaleString("eng", {weekday: 'long' })
